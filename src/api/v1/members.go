...
func HandleMembers() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Header.Get("HX-Request") == "true" {
			html.MembersView(languageContent.Members.MemberItems, languageContent, theme).Render(r.Context(), w)
			return
		}

		html.Document(languageContent, theme, html.MembersView(languageContent.Members.MemberItems, languageContent, theme)).Render(r.Context(), w)
	}
}
